...
def transfer_num(data):  # transfer num into "NUM"
    ...
    for d in data:
        ...
        pairs.append((input_seq, out_seq, nums, num_pos, answer, id2))
    #     string = str(len(nums))
...
def prepare_train_batch(pairs_to_batch, batch_size):
    ...
    for batch in batches:
        ...
        num_ans_batch = []
        num_id_batch = []
        for i, li, j, lj, num, num_pos, num_stack, answer, id2 in batch:
    ...
    return input_batches, input_lengths, output_batches, output_lengths, nums_batches, num_stack_batches, num_pos_batches, num_size_batches, num_ans_batches, num_id_batches
